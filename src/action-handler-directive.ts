...
customElements.define('action-handler-dog-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-dog-card')) {
    return body.querySelector('action-handler-dog-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-dog-card');
